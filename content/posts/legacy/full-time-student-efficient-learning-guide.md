...
| 学习目标 | 建议每日投入 | 主要学习任务 | AI/工具辅助 |
| :--- | :--- | :--- | :--- |
| **英语学习** | 2 个番茄（约1 小时） | 阅读英文文章/书籍，听英文播客/新闻；英语写作或口语练习（如写日记或对话模拟） | ChatGPT Pro（生词释义、语法纠错、生成总结）；Notion（记录生词、例句） |
| **AI技术与算法** | 3 个番茄（约1.5 小时） | 学习AI理论（在线课程/论文）；算法代码实践（刷题或项目） | ChatGPT Pro（解答概念疑问、总结要点）；Claude Code/Gemini CLI（代码生成与调试）；Notion（记录教程要点） |
| **专业课程学习** | 5 个番茄（约2.5 小时） | 预习/复习课堂笔记与教材；完成作业或练习题 | ChatGPT Pro（难点讲解、习题提示）；Notion（课件笔记、任务清单） |
